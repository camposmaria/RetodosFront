...
function userlogging(){
    ...
    $.ajax({    
        ...
        url: 'http://129.151.117.213:8080/api/user/'+userEmail+'/'+userPass,
        ...
        success : function(json, textStatus, xhr) {
                ...
                if(json.id == null){
                    ...
                    location.href="http://129.151.117.213:8080/adminUser.html";
...
function verEmail(){
    ...
    $.ajax({    
        ...
        url: 'http://129.151.117.213:8080/api/user/emailexist/'+userEmailVer,
...
function creacionIdL(){
    ...
    $.ajax({    
        url : 'http://129.151.117.213:8080/api/user/all',
    //  data : { id : 123 },
        type : 'GET',
        dataType : 'json',
...
function saveUser(){
    ...
    $.ajax({
        ...
        url:"http://129.151.117.213:8080/api/user/new",
