...
function borrarUsuario(id){
        ...
        $.ajax({    
            ...
            url : "http://129.151.117.213:8080/api/user/"+id,
            type: 'DELETE',
...
function ObtenerDatos(id){
  ...
  cambioClass();
    ...
    $.ajax({    
        url : 'http://129.151.117.213:8080/api/user/'+window.dataToSend,
    //  data : { id : 123 },
        type : 'GET',
        dataType : 'json',
...
$.ajax({    
  ...
  url: 'http://129.151.117.213:8080/api/user/emailexist/'+userEmail,
...
function guardarCambios(){
    ...
    $.ajax({    
        ...
        url: 'http://129.151.117.213:8080/api/user/update',
